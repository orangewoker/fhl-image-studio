...
export const ANDROID_UPSTREAM_MODE_OPTIONS: Array<{
  ...
  { id: "images", title: "新建 OpenAI 标准 v1", meta: "图像 + /v1/chat/completions / 可拉取模型列表" },
...
export const ANDROID_API_MODE_OPTIONS: Array<{
  ...
  { id: "images", title: "OpenAI 标准 v1", meta: "/v1/chat/completions · /v1/images/generations · /v1/images/edits" },
