...
export function AndroidPadComposePanel() {
  ...
  return (
    <div
      ...
      style={{ paddingLeft: "calc(var(--android-safe-left-value, env(safe-area-inset-left, 0px)) + 16px)", paddingRight: "calc(var(--android-safe-right-value, env(safe-area-inset-right, 0px)) + 16px)" }}
    >
      ...
      <div className="android-pad-cta" style={{ paddingLeft: "calc(var(--android-safe-left-value, env(safe-area-inset-left, 0px)) + 16px)", paddingRight: "calc(var(--android-safe-right-value, env(safe-area-inset-right, 0px)) + 16px)" }}>
        {submitButton}
      </div>
