...
const storageNamespace = (process.env.IMAGE_STUDIO_STORAGE_NAMESPACE || "fhl-image-studio-v2.0.0-release-clean-20260605-3")
  .trim()
  .replace(/[^a-zA-Z0-9._-]+/g, "-")
  .replace(/^-+|-+$/g, "")
  || "fhl-image-studio-v2.0.0-release-clean-20260605-3";
...
function renderCLIEnv(input: {
  ...
  return [
    "# Auto-generated by FHL Image Studio UI.",
