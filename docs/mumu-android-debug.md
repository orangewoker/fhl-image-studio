...
本文档记录 FHL Studio 安卓端在 MuMu 模拟器中的常用调试流程，方便多人协作时使用同一套构建、安装、截图和排错方法。
...
- Debug 包名：`top.fangtangyuan.fhlstudio.android.debug`
...
/Applications/MuMuPlayer.app/Contents/MacOS/MuMuEmulator.app/Contents/MacOS/tools/adb \
  -s 127.0.0.1:16384 \
  shell monkey -p top.fangtangyuan.fhlstudio.android.debug -c android.intent.category.LAUNCHER 1
```
